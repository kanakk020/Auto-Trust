        ...
        <div className="bg-[#0f172a]/80 backdrop-blur-xl border border-white/10 rounded-3xl p-6 md:p-8 shadow-2xl relative overflow-hidden">
          ...
          <AnimatePresence mode="wait">
            {step === 'role' ? (
              ...
              >
                <div className="flex bg-slate-800/50 p-1.5 rounded-xl mb-8 border border-slate-700">
                  <button 
                    className={`flex-1 py-2.5 text-sm font-medium rounded-lg transition-all ${isLogin ? 'bg-indigo-600 shadow-md text-white' : 'text-slate-400 hover:text-slate-200'}`}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <input type="email" placeholder="Email Address" className="w-full pl-12 pr-4 py-3 bg-slate-900/50 border border-slate-700 text-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all placeholder:text-slate-600" required />
                  </div>
                  ...
                  <div className="pt-2">
                    ...
                    <button 
                      ...
                      className="w-full mt-3 py-3 rounded-xl text-slate-400 font-medium hover:text-slate-200 hover:bg-slate-800/50 border border-transparent hover:border-slate-700 transition-all text-sm"
                    >
...
const AnimateHeight = ({ children }) => (
  <motion.div
    initial={false}
    animate={{ height: children ? 'auto' : 0, opacity: children ? 1 : 0, marginBottom: children ? 16 : 0 }}
